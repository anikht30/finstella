...
from forum.views import checkout_view,process_dummy_payment
...
urlpatterns = [
    ...
    path('topic/<int:category_id>',category_details,name="topic_details"),
    ...
    path('checkout/process/', process_dummy_payment, name='process_payment'),
